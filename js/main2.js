(function() {
    ...
    window.CanvasSlideshow = function( options ) {
      ...
      this.initPixi = function() {
        ...
        document.getElementById("throwback").appendChild( renderer.view );
      ...
      function scaleToWindow( canvas, backgroundColor ) {
        ...
        //3. Remove any padding from the canvas  and getElementById("throwback") and set the canvas
        ...
        //4. Set the color of the HTML getElementById("throwback") background
